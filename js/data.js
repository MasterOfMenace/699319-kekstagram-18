...
window.data = (function () {
  ...
  function createPhoto(i) {
    ...
    photo.likes = window.util.getRandomNumber(LIKES.MIN, LIKES.MAX);
    photo.comments = createArray(window.util.getRandomNumber(COMMENTS.MIN, COMMENTS.MAX), createComment);
    return photo;
  }
  ...
  function createComment() {
    var comment = {};
    comment.avatar = 'img/avatar-' + window.util.getRandomNumber(AVATARS.MIN, AVATARS.MAX) + '.svg';
